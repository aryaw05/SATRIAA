  ...
  Route::middleware('web')->group(function () {
    ...
    Route::middleware(['auth', \App\Http\Middleware\RoleMiddleware::class . ':admin'])->group(function () {
      // jadwal routes
      Route::get('/admin/dashboard/jadwal', [JadwalBusController::class, 'index'])->name('jadwal.index');
      ...
      Route::post('/updateKondisiBus', [KondisiBusController::class, 'update'])->name('update.KondisiBus');
  ...
  // Routing data bus
    ...
    Route::middleware(['auth', \App\Http\Middleware\RoleMiddleware::class . ':kernet'])->group(function () {
      ...
      Route::put('/kernet/dashboard/bus/updateKondisi/{bus}', [KernetController::class, 'updateKondisi']);
      Route::put('/kernet/dashboard/bus/updateKapasitas/{bus}', [KernetController::class, 'updateKapasitas']);
      Route::put('/kernet/dashboard/bus/updateStatus/{bus}', [KernetController::class, 'updateStatus']);

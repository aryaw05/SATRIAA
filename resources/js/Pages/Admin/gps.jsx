          ...
          <div className="flex items-center justify-between mb-1">
            {isActive ? (
              <div className="flex items-center space-x-2">
                ...
                <h3 className="font-bold text-4xl text-green-600">Aktif</h3>
              </div>
            ) : (
              <div className="flex items-center space-x-2">
                <FontAwesomeIcon icon={faCircleXmark} className="text-red-500 text-4xl" />
                <h3 className="font-bold text-4xl text-red-600">Non-Aktif</h3>
              </div>
            )}
            <input
              type="checkbox"
              ...
              <div className="w-full">
                <div className="dropdown  w-full" onClick={(e) => e.stopPropagation()}>
                  <button
                    ...
                    onClick={() => setOpenKepadatan(!openKepadatan)}
                  >
                    {kepadatan}
                    <svg
                      className={`w-4 h-4 ml-2 transition-transform ${openKepadatan ? 'rotate-180' : ''}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                  ...
                  {openKepadatan && (
                    <ul className="mt-1 p-2 shadow menu dropdown-content bg-white text-lg rounded-2xl w-full z-10">
                      <li>
                        <button className="bg-yellow-100" onClick={() => {
                      ...
                      <li>
                        <button className="bg-yellow-100" onClick={() => {
                          setKepadatan('50% Cukup Ramai');
                          setOpenKepadatan(false);
                        }}>50% Cukup Ramai</button>
                      </li>
                      <li>
                        <button onClick={() => {
              ...
              <div className="w-full">
                <div className="dropdown w-full" onClick={(e) => e.stopPropagation()}>
                  <button
                    ...
                    onClick={() => setOpenStatusBus(!openStatusBus)}
                  >
                    <FontAwesomeIcon icon={"fa-solid fa-bus"} className="text-3xl text-black" />
                    <span className="flex-1 text-left">{statusBus}</span>
                    <svg
                      className={`w-4 h-4 transition-transform ${openStatusBus ? 'rotate-180' : ''}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  {openStatusBus && (
                    <ul className="mt-1 p-2 shadow menu dropdown-content text-lg bg-white rounded-2xl w-full z-10">
                      <li>
                        <button className="bg-yellow-100" onClick={() => {
                          setStatusBus('Bus Dalam Perjalanan');
                          setOpenStatusBus(false);
                        }}>Bus Dalam Perjalanan</button>
                      </li>
                      <li>
                        <button onClick={() => {
                          setStatusBus('Bus Mengalami Trouble');
                          setOpenStatusBus(false);
                        }}>Bus Mengalami Trouble</button>
                      </li>
                      <li>
                        <button className="bg-yellow-100" onClick={() => {
                          setStatusBus('Bus Terkena Macet');
                          setOpenStatusBus(false);
                        }}>Bus Terkena Macet</button>
                      </li>
                      <li>
                        <button onClick={() => {
                          setStatusBus('Bus Tidak Beroperasi');
                          setOpenStatusBus(false);
                        }}>Bus Tidak Beroperasi</button>
                      </li>
                      <li>
                        <button className="bg-yellow-100" onClick={() => {
                          setStatusBus('Sopir Sedang Ngopi');
                          setOpenStatusBus(false);
                        }}>Sopir Sedang Ngopi</button>
                      </li>
                    </ul>
                  )}
                </div>

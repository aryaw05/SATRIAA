...
const HalteSatria = (props) => {
  ...
  <form
    action=""
    onSubmit={(e) => handleSubmit(e, "/createHalte", formData)}
  >
    ...
    <div className="flex justify-between rounded-3xl bg-[#f1c65d] shadow-md ">
      ...
      <div className="flex items-center px-4">
        <div className="dropdown dropdown-top dropdown-end">
          ...
          >
            <li>
              <button onClick={() => showModalEdit("editModal")}>
                Edit Halte
              </button>
            </li>
            <li>
              <button
                ...
                onClick={() =>
                  handleDelete(dataHalte.halte_id, "deleteHalte")
                }
              >
                Delete Halte
              </button>
  ...
  <div className="modal-box rounded-3xl w-[95%] max-w-md">
    ...
    <form
      ...
      onSubmit={(e) => {
            handleEdit(e, "editHalte", dataHalte.halte_id, formData);
      }}
    >
      <div>

            ...
            <div className="bg-gray-100 min-h-screen mx-5">
                <div className="bg-white rounded-3xl mt-10 mx-5 px-6 py-6 w-full max-w-md mx-auto">
                    <div className="flex">
                        ...
                        <button onClick={handleLogout} className="bg-red-500 rounded-md px-6 h-12 shadow-md text-white font-bold hover:bg-red-400 cursor-pointer ml-auto">Logout</button>
                    </div>
